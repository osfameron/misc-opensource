package MooseX::LazyValue::Attribute;
use Moose;

extends q(Moose::Meta::Attribute);
with q(MooseX::LazyValue::Trait);

no Moose;

package # Move along, PAUSE...
    Moose::Meta::Attribute::Custom::LazyValue;

sub register_implementation { q(MooseX::LazyValue::Attribute) }
